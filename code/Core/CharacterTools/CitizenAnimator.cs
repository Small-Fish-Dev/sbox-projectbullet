...
/// </summary>
public class CitizenAnimator : PlayerAnimator
{
	public override void Simulate( IClient cl )
	{
		...
		animHelper.DuckLevel = MathX.Lerp( animHelper.DuckLevel,
			1 - controller.CurrentEyeHeight.Remap( 30, 72, 0, 1 ).Clamp( 0, 1 ), Time.Delta * 10.0f );
		animHelper.VoiceLevel = Game.IsClient && cl.IsValid()
			? cl.Voice.LastHeard < 0.5f ? cl.Voice.CurrentLevel : 0.0f
			: 0.0f;
